...
#include "../../../demo/vendor/eaglet_mouse_demo/AAA_app_config_Telink_QFN32.h"
#elif (_PRJ_EAGLET_KEYBOARD_)
#include "../../../demo/vendor/eaglet_keyboard_demo/AAA_app_config_Telink_QFN32.h"
#elif (_PRJ_EAGLET_DONGLE_)
#include "../../../demo/vendor/eaglet_dongle_Demo/AAA_app_config.h"
#elif (_PRJ_SENEASY)
#include "../../../app/main/AAA_app_config.h"
#endif
...
#define GPIO_PF0_PULL_FLOAT			do{ unsigned char val = analog_read(areg_16_pf0_pf1_pull);  val &= ~0x03;   				analog_write(areg_16_pf0_pf1_pull, val); }while(0)
#define GPIO_PF0_PULL_UP_1M			do{ unsigned char val = analog_read(areg_16_pf0_pf1_pull);  val &= ~0x02;	val |=  0x01;   analog_write(areg_16_pf0_pf1_pull, val); }while(0)
#define GPIO_PF0_PULL_DOWN_100K		do{ unsigned char val = analog_read(areg_16_pf0_pf1_pull);  val |=  0x02;	val &= ~0x01;   analog_write(areg_16_pf0_pf1_pull, val); }while(0)
#define GPIO_PF0_PULL_UP_10K		do{ unsigned char val = analog_read(areg_16_pf0_pf1_pull);  val |=  0x03;   				analog_write(areg_16_pf0_pf1_pull, val); }while(0)
#define GPIO_PF0_PULL_TOGGLE		do{ unsigned char val = analog_read(areg_16_pf0_pf1_pull);  val ^=  0x01;   				analog_write(areg_16_pf0_pf1_pull, val); }while(0)

#define GPIO_PF1_PULL_FLOAT			do{ unsigned char val = analog_read(areg_16_pf0_pf1_pull);  val &= ~0x0C;   				analog_write(areg_16_pf0_pf1_pull, val); }while(0)
#define GPIO_PF1_PULL_UP_1M			do{ unsigned char val = analog_read(areg_16_pf0_pf1_pull);  val &= ~0x08;	val |=  0x04;   analog_write(areg_16_pf0_pf1_pull, val); }while(0)
#define GPIO_PF1_PULL_DOWN_100K		do{ unsigned char val = analog_read(areg_16_pf0_pf1_pull);  val |=  0x08;	val &= ~0x04;   analog_write(areg_16_pf0_pf1_pull, val); }while(0)
#define GPIO_PF1_PULL_UP_10K		do{ unsigned char val = analog_read(areg_16_pf0_pf1_pull);  val |=  0x0C;   				analog_write(areg_16_pf0_pf1_pull, val); }while(0)
#define GPIO_PF1_PULL_TOGGLE		do{ unsigned char val = analog_read(areg_16_pf0_pf1_pull);  val ^=  0x04;   				analog_write(areg_16_pf0_pf1_pull, val); }while(0)


#define GPIO_PA0_OUTPUT_LOW			( (*(volatile unsigned char *)0x800503) &= (~0x01) )
#define GPIO_PA0_OUTPUT_HIGH		( (*(volatile unsigned char *)0x800503) |= 0x01    )
#define GPIO_PA0_OUTPUT_TOGGLE		( (*(volatile unsigned char *)0x800503) ^= 0x01    )
#define GPIO_PA1_OUTPUT_LOW			( (*(volatile unsigned char *)0x800503) &= (~0x02) )
#define GPIO_PA1_OUTPUT_HIGH		( (*(volatile unsigned char *)0x800503) |= 0x02    )
#define GPIO_PA1_OUTPUT_TOGGLE		( (*(volatile unsigned char *)0x800503) ^= 0x02    )
#define GPIO_PA2_OUTPUT_LOW			( (*(volatile unsigned char *)0x800503) &= (~0x04) )
#define GPIO_PA2_OUTPUT_HIGH		( (*(volatile unsigned char *)0x800503) |= 0x04    )
#define GPIO_PA2_OUTPUT_TOGGLE		( (*(volatile unsigned char *)0x800503) ^= 0x04    )
#define GPIO_PA3_OUTPUT_LOW			( (*(volatile unsigned char *)0x800503) &= (~0x08) )
#define GPIO_PA3_OUTPUT_HIGH		( (*(volatile unsigned char *)0x800503) |= 0x08    )
#define GPIO_PA3_OUTPUT_TOGGLE		( (*(volatile unsigned char *)0x800503) ^= 0x08    )
#define GPIO_PA4_OUTPUT_LOW			( (*(volatile unsigned char *)0x800503) &= (~0x10) )
#define GPIO_PA4_OUTPUT_HIGH		( (*(volatile unsigned char *)0x800503) |= 0x10    )
#define GPIO_PA4_OUTPUT_TOGGLE		( (*(volatile unsigned char *)0x800503) ^= 0x10    )
#define GPIO_PA5_OUTPUT_LOW			( (*(volatile unsigned char *)0x800503) &= (~0x20) )
#define GPIO_PA5_OUTPUT_HIGH		( (*(volatile unsigned char *)0x800503) |= 0x20    )
#define GPIO_PA5_OUTPUT_TOGGLE		( (*(volatile unsigned char *)0x800503) ^= 0x20    )
#define GPIO_PA6_OUTPUT_LOW			( (*(volatile unsigned char *)0x800503) &= (~0x40) )
#define GPIO_PA6_OUTPUT_HIGH		( (*(volatile unsigned char *)0x800503) |= 0x40    )
#define GPIO_PA6_OUTPUT_TOGGLE		( (*(volatile unsigned char *)0x800503) ^= 0x40    )
#define GPIO_PA7_OUTPUT_LOW			( (*(volatile unsigned char *)0x800503) &= (~0x80) )
#define GPIO_PA7_OUTPUT_HIGH		( (*(volatile unsigned char *)0x800503) |= 0x80    )
#define GPIO_PA7_OUTPUT_TOGGLE		( (*(volatile unsigned char *)0x800503) ^= 0x80    )

#define GPIO_PB0_OUTPUT_LOW			( (*(volatile unsigned char *)0x80050b) &= (~0x01) )
#define GPIO_PB0_OUTPUT_HIGH		( (*(volatile unsigned char *)0x80050b) |= 0x01    )
#define GPIO_PB0_OUTPUT_TOGGLE		( (*(volatile unsigned char *)0x80050b) ^= 0x01    )
#define GPIO_PB1_OUTPUT_LOW			( (*(volatile unsigned char *)0x80050b) &= (~0x02) )
#define GPIO_PB1_OUTPUT_HIGH		( (*(volatile unsigned char *)0x80050b) |= 0x02    )
#define GPIO_PB1_OUTPUT_TOGGLE		( (*(volatile unsigned char *)0x80050b) ^= 0x02    )
#define GPIO_PB2_OUTPUT_LOW			( (*(volatile unsigned char *)0x80050b) &= (~0x04) )
#define GPIO_PB2_OUTPUT_HIGH		( (*(volatile unsigned char *)0x80050b) |= 0x04    )
#define GPIO_PB2_OUTPUT_TOGGLE		( (*(volatile unsigned char *)0x80050b) ^= 0x04    )
#define GPIO_PB3_OUTPUT_LOW			( (*(volatile unsigned char *)0x80050b) &= (~0x08) )
#define GPIO_PB3_OUTPUT_HIGH		( (*(volatile unsigned char *)0x80050b) |= 0x08    )
#define GPIO_PB3_OUTPUT_TOGGLE		( (*(volatile unsigned char *)0x80050b) ^= 0x08    )
#define GPIO_PB4_OUTPUT_LOW			( (*(volatile unsigned char *)0x80050b) &= (~0x10) )
#define GPIO_PB4_OUTPUT_HIGH		( (*(volatile unsigned char *)0x80050b) |= 0x10    )
#define GPIO_PB4_OUTPUT_TOGGLE		( (*(volatile unsigned char *)0x80050b) ^= 0x10    )
#define GPIO_PB5_OUTPUT_LOW			( (*(volatile unsigned char *)0x80050b) &= (~0x20) )
#define GPIO_PB5_OUTPUT_HIGH		( (*(volatile unsigned char *)0x80050b) |= 0x20    )
#define GPIO_PB5_OUTPUT_TOGGLE		( (*(volatile unsigned char *)0x80050b) ^= 0x20    )
#define GPIO_PB6_OUTPUT_LOW			( (*(volatile unsigned char *)0x80050b) &= (~0x40) )
#define GPIO_PB6_OUTPUT_HIGH		( (*(volatile unsigned char *)0x80050b) |= 0x40    )
#define GPIO_PB6_OUTPUT_TOGGLE		( (*(volatile unsigned char *)0x80050b) ^= 0x40    )
#define GPIO_PB7_OUTPUT_LOW			( (*(volatile unsigned char *)0x80050b) &= (~0x80) )
#define GPIO_PB7_OUTPUT_HIGH		( (*(volatile unsigned char *)0x80050b) |= 0x80    )
#define GPIO_PB7_OUTPUT_TOGGLE		( (*(volatile unsigned char *)0x80050b) ^= 0x80    )

#define GPIO_PC0_OUTPUT_LOW			( (*(volatile unsigned char *)0x800513) &= (~0x01) )
#define GPIO_PC0_OUTPUT_HIGH		( (*(volatile unsigned char *)0x800513) |= 0x01    )
#define GPIO_PC0_OUTPUT_TOGGLE		( (*(volatile unsigned char *)0x800513) ^= 0x01    )
#define GPIO_PC1_OUTPUT_LOW			( (*(volatile unsigned char *)0x800513) &= (~0x02) )
#define GPIO_PC1_OUTPUT_HIGH		( (*(volatile unsigned char *)0x800513) |= 0x02    )
#define GPIO_PC1_OUTPUT_TOGGLE		( (*(volatile unsigned char *)0x800513) ^= 0x02    )
#define GPIO_PC2_OUTPUT_LOW			( (*(volatile unsigned char *)0x800513) &= (~0x04) )
#define GPIO_PC2_OUTPUT_HIGH		( (*(volatile unsigned char *)0x800513) |= 0x04    )
#define GPIO_PC2_OUTPUT_TOGGLE		( (*(volatile unsigned char *)0x800513) ^= 0x04    )
#define GPIO_PC3_OUTPUT_LOW			( (*(volatile unsigned char *)0x800513) &= (~0x08) )
#define GPIO_PC3_OUTPUT_HIGH		( (*(volatile unsigned char *)0x800513) |= 0x08    )
#define GPIO_PC3_OUTPUT_TOGGLE		( (*(volatile unsigned char *)0x800513) ^= 0x08    )
#define GPIO_PC4_OUTPUT_LOW			( (*(volatile unsigned char *)0x800513) &= (~0x10) )
#define GPIO_PC4_OUTPUT_HIGH		( (*(volatile unsigned char *)0x800513) |= 0x10    )
#define GPIO_PC4_OUTPUT_TOGGLE		( (*(volatile unsigned char *)0x800513) ^= 0x10    )
#define GPIO_PC5_OUTPUT_LOW			( (*(volatile unsigned char *)0x800513) &= (~0x20) )
#define GPIO_PC5_OUTPUT_HIGH		( (*(volatile unsigned char *)0x800513) |= 0x20    )
#define GPIO_PC5_OUTPUT_TOGGLE		( (*(volatile unsigned char *)0x800513) ^= 0x20    )
#define GPIO_PC6_OUTPUT_LOW			( (*(volatile unsigned char *)0x800513) &= (~0x40) )
#define GPIO_PC6_OUTPUT_HIGH		( (*(volatile unsigned char *)0x800513) |= 0x40    )
#define GPIO_PC6_OUTPUT_TOGGLE		( (*(volatile unsigned char *)0x800513) ^= 0x40    )
#define GPIO_PC7_OUTPUT_LOW			( (*(volatile unsigned char *)0x800513) &= (~0x80) )
#define GPIO_PC7_OUTPUT_HIGH		( (*(volatile unsigned char *)0x800513) |= 0x80    )
#define GPIO_PC7_OUTPUT_TOGGLE		( (*(volatile unsigned char *)0x800513) ^= 0x80    )

#define GPIO_PD0_OUTPUT_LOW			( (*(volatile unsigned char *)0x80051b) &= (~0x01) )
#define GPIO_PD0_OUTPUT_HIGH		( (*(volatile unsigned char *)0x80051b) |= 0x01    )
#define GPIO_PD0_OUTPUT_TOGGLE		( (*(volatile unsigned char *)0x80051b) ^= 0x01    )
#define GPIO_PD1_OUTPUT_LOW			( (*(volatile unsigned char *)0x80051b) &= (~0x02) )
#define GPIO_PD1_OUTPUT_HIGH		( (*(volatile unsigned char *)0x80051b) |= 0x02    )
#define GPIO_PD1_OUTPUT_TOGGLE		( (*(volatile unsigned char *)0x80051b) ^= 0x02    )
#define GPIO_PD2_OUTPUT_LOW			( (*(volatile unsigned char *)0x80051b) &= (~0x04) )
#define GPIO_PD2_OUTPUT_HIGH		( (*(volatile unsigned char *)0x80051b) |= 0x04    )
#define GPIO_PD2_OUTPUT_TOGGLE		( (*(volatile unsigned char *)0x80051b) ^= 0x04    )
#define GPIO_PD3_OUTPUT_LOW			( (*(volatile unsigned char *)0x80051b) &= (~0x08) )
#define GPIO_PD3_OUTPUT_HIGH		( (*(volatile unsigned char *)0x80051b) |= 0x08    )
#define GPIO_PD3_OUTPUT_TOGGLE		( (*(volatile unsigned char *)0x80051b) ^= 0x08    )
#define GPIO_PD4_OUTPUT_LOW			( (*(volatile unsigned char *)0x80051b) &= (~0x10) )
#define GPIO_PD4_OUTPUT_HIGH		( (*(volatile unsigned char *)0x80051b) |= 0x10    )
#define GPIO_PD4_OUTPUT_TOGGLE		( (*(volatile unsigned char *)0x80051b) ^= 0x10    )
#define GPIO_PD5_OUTPUT_LOW			( (*(volatile unsigned char *)0x80051b) &= (~0x20) )
#define GPIO_PD5_OUTPUT_HIGH		( (*(volatile unsigned char *)0x80051b) |= 0x20    )
#define GPIO_PD5_OUTPUT_TOGGLE		( (*(volatile unsigned char *)0x80051b) ^= 0x20    )
#define GPIO_PD6_OUTPUT_LOW			( (*(volatile unsigned char *)0x80051b) &= (~0x40) )
#define GPIO_PD6_OUTPUT_HIGH		( (*(volatile unsigned char *)0x80051b) |= 0x40    )
#define GPIO_PD6_OUTPUT_TOGGLE		( (*(volatile unsigned char *)0x80051b) ^= 0x40    )
#define GPIO_PD7_OUTPUT_LOW			( (*(volatile unsigned char *)0x80051b) &= (~0x80) )
#define GPIO_PD7_OUTPUT_HIGH		( (*(volatile unsigned char *)0x80051b) |= 0x80    )
#define GPIO_PD7_OUTPUT_TOGGLE		( (*(volatile unsigned char *)0x80051b) ^= 0x80    )

#define GPIO_PF0_OUTPUT_LOW			( (*(volatile unsigned char *)0x80052b) &= (~0x01) )
#define GPIO_PF0_OUTPUT_HIGH		( (*(volatile unsigned char *)0x80052b) |= 0x01    )
#define GPIO_PF0_OUTPUT_TOGGLE		( (*(volatile unsigned char *)0x80052b) ^= 0x01    )
#define GPIO_PF1_OUTPUT_LOW			( (*(volatile unsigned char *)0x80052b) &= (~0x02) )
#define GPIO_PF1_OUTPUT_HIGH		( (*(volatile unsigned char *)0x80052b) |= 0x02    )
#define GPIO_PF1_OUTPUT_TOGGLE		( (*(volatile unsigned char *)0x80052b) ^= 0x02    )
