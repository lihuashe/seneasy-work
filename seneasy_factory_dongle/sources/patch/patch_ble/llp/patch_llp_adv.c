...
extern volatile EN_LLP_ADV_SUB_STATE_T g_llpAdvSubState;


EN_LLP_ERR_T patch_llp_adv_fragment_start(stLlpAdvFragmentParam_t* pstParam)
{
    ...
    err = rom_llp_hw_set_work_time_us(LLP_FRAGMENT_TYPE_ADV, pstParam->u32WorkTimeUs);
    if(LLP_ERR_NONE != err)
    {
        return err;
    }
    ...
    g_llpAdvSubState = LLP_ADV_SUB_STATE_IDLE;
