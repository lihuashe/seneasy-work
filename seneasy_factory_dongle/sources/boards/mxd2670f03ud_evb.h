...
#ifndef __MXD2670F03UD_EVB__H__
#define __MXD2670F03UD_EVB__H__
...
#define GPIO_PIN_UART0_TX                  (GPIO_PIN_19) //P51, PB19
#define GPIO_PORT_UART0_RX                 (GPIOB)
#define GPIO_PIN_UART0_RX                  (GPIO_PIN_21) //P53, PB21
