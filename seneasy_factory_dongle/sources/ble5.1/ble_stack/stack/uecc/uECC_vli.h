...
void rom_uECC_vli_mmod_fast(uECC_word_t *result, uECC_word_t *product, uECC_Curve curve);
...
void rom_uECC_vli_mod_sqrt(uECC_word_t *a, uECC_Curve curve);
#endif
...
unsigned rom_uECC_curve_num_words(uECC_Curve curve);
unsigned rom_uECC_curve_num_bytes(uECC_Curve curve);
unsigned rom_uECC_curve_num_bits(uECC_Curve curve);
unsigned rom_uECC_curve_num_n_words(uECC_Curve curve);
unsigned rom_uECC_curve_num_n_bytes(uECC_Curve curve);
unsigned rom_uECC_curve_num_n_bits(uECC_Curve curve);
...
int rom_uECC_valid_point(const uECC_word_t *point, uECC_Curve curve);
