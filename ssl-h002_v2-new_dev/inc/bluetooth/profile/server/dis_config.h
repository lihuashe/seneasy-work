...
#define DIS_CHAR_SERIAL_NUMBER_STR_MAX_LENGTH       25 /**< Max length of Serial Number String characteristic value*/
#endif
...
#define DIS_CHAR_HARDWARE_REVISION_STR_MAX_LENGTH   30 /**< Max length of Hardware Revision String scharacteristic value*/
#endif
