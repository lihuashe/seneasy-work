...
*/
#define RCU_CONNECT_INTERVAL                0x0c  /*0x0c * 1.25ms = 15ms*/
#define RCU_CONNECT_LATENCY                 5
#define RCU_SUPERVISION_TIMEOUT             4000  /* 5s */
...
typedef struct
{
    ...
    bool wake_up_from_dss; /* to indicate rcu wakes up from dss */
#endif
