...
#define TIMER_ID_DFU_WAIT_PACKET        5
...
void *wait_packet_timer_handle;
uint32_t timeout_value_wait_packet;
#endif
...
void dfu_le_gap_init(void)
{
    ...
    uint8_t  auth_pair_mode = GAP_PAIRING_MODE_NO_PAIRING;
...
void dfu_timer_init(void)
{
...
#if OTA_TIMEOUT_WAIT_PACKET
    timeout_value_wait_packet =  OTP->ota_timeout_wait_packet * 1000;
#endif
    ...
    {
        os_timer_create(&wait_packet_timer_handle, "dfuWaitPacketTimer", TIMER_ID_DFU_WAIT_PACKET,
                        timeout_value_wait_packet, false, dfu_monitor_timeout_handler);
    }
#endif
