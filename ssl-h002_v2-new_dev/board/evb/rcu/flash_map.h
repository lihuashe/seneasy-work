...
example:
    ...
    3) OTA Bank0:                                    340K (0x00802000)
        ...
        e) APP code                    144K (0x00832000)
        f) APP data1                     4K (0x00856000)
...
#define BKP_DATA1_ADDR                  0x00880000
...
#define BANK0_APP_SIZE                  0x00024000  //144K Bytes
#define BANK0_APP_DATA1_ADDR            0x00856000
#define BANK0_APP_DATA1_SIZE            0x00001000  //4K Bytes
