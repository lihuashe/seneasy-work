 ...
 *
 * @return current time, uint is 31.25us
 **/
 ...
 **/
STATIC_INLINE bool co_time_compare_lesser(uint32_t me, uint32_t he)
{
    return (me != he) && co_time_compare_equal_lesser(me, he);
}
 ...
 **/
STATIC_INLINE bool co_time_compare_equal_greater(uint32_t me, uint32_t he)
{
    return (me == he) || !co_time_compare_equal_lesser(me, he);
}
 ...
 **/
STATIC_INLINE bool co_time_compare_greater(uint32_t me, uint32_t he)
{
    return !co_time_compare_equal_lesser(me, he);
}
