#ifndef __XH51_BITS_H
#define __XH51_BITS_H
...
/* Bit 0 : Override default values for XH_1Mbit mode. */
#define FICR_OVERRIDEEN_XH_1MBIT_Pos (0UL) /*!< Position of XH_1MBIT field. */
#define FICR_OVERRIDEEN_XH_1MBIT_Msk (0x1UL << FICR_OVERRIDEEN_XH_1MBIT_Pos) /*!< Bit mask of XH_1MBIT field. */
#define FICR_OVERRIDEEN_XH_1MBIT_Override (0UL) /*!< Override the default values for XH_1Mbit mode. */
#define FICR_OVERRIDEEN_XH_1MBIT_NotOverride (1UL) /*!< Do not override the default values for XH_1Mbit mode. */
...
#define RADIO_MODE_MODE_Xh_1Mbit (0x00UL) /*!< 1Mbit/s XIHAO propietary radio mode. */
#define RADIO_MODE_MODE_Xh_2Mbit (0x01UL) /*!< 2Mbit/s XIHAO propietary radio mode. */
#define RADIO_MODE_MODE_Xh_250Kbit (0x02UL) /*!< 250kbit/s XIHAO propietary radio mode. */
