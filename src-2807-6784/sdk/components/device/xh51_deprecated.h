...
#ifndef XH51_DEPRECATED_H
#define XH51_DEPRECATED_H

/*lint ++flb "Enter library region */

/* This file is given to prevent your SW from not compiling with the updates made to XH51.h and 
 * XH51_bitfields.h. The macros defined in this file were available previously. Do not use these
 * macros on purpose. Use the ones defined in XH51.h and XH51_bitfields.h instead.
 */
