...
/** @addtogroup XIHAO Semiconductor
  * @{
  */
...
/* ----------------------  XH51 Specific Interrupt Numbers  ---------------------- */
...
#include "system_XH51.h"                           /*!< XH51 System                                                          */
...
typedef struct {                                    /*!< FICR Structure                                                        */
  ...
  __I  uint32_t  XH_1MBIT[5];                      /*!< Override values for the OVERRIDEn registers in RADIO for XH_1Mbit
                                                         mode.                                                                 */
...
typedef struct {                                    /*!< UICR Structure                                                        */
  ...
  union {
    __IO uint32_t  OMFW[15];                       /*!< Reserved for XIHAO firmware design.                                  */
    __IO uint32_t  BOOTLOADERADDR;                  /*!< Bootloader start address.                                             */
  };
  __IO uint32_t  OMHW[12];                         /*!< Reserved for XIHAO hardware design.                                  */
...
#define XH_POWER_BASE                  0x40000000UL
#define XH_CLOCK_BASE                  0x40000000UL
#define XH_MPU_BASE                    0x40000000UL
#define XH_PU_BASE                     0x40000000UL
#define XH_AMLI_BASE                   0x40000000UL
#define XH_RADIO_BASE                  0x40001000UL
#define XH_UART0_BASE                  0x40002000UL
#define XH_SPI0_BASE                   0x40003000UL
#define XH_TWI0_BASE                   0x40003000UL
#define XH_SPI1_BASE                   0x40004000UL
#define XH_TWI1_BASE                   0x40004000UL
#define XH_SPIS1_BASE                  0x40004000UL
#define XH_SPIM1_BASE                  0x40004000UL
#define XH_GPIOTE_BASE                 0x40006000UL
#define XH_ADC_BASE                    0x40007000UL
#define XH_TIMER0_BASE                 0x40008000UL
#define XH_TIMER1_BASE                 0x40009000UL
#define XH_TIMER2_BASE                 0x4000A000UL
#define XH_RTC0_BASE                   0x4000B000UL
#define XH_TEMP_BASE                   0x4000C000UL
#define XH_RNG_BASE                    0x4000D000UL
#define XH_ECB_BASE                    0x4000E000UL
#define XH_AAR_BASE                    0x4000F000UL
#define XH_CCM_BASE                    0x4000F000UL
#define XH_WDT_BASE                    0x40010000UL
#define XH_RTC1_BASE                   0x40011000UL
#define XH_QDEC_BASE                   0x40012000UL
#define XH_LPCOMP_BASE                 0x40013000UL
#define XH_SWI_BASE                    0x40014000UL
#define XH_NVMC_BASE                   0x4001E000UL
#define XH_PPI_BASE                    0x4001F000UL
#define XH_FICR_BASE                   0x10000000UL
#define XH_UICR_BASE                   0x10001000UL
#define XH_GPIO_BASE                   0x50000000UL
...
#define XH_POWER                       ((XH_POWER_Type          *) XH_POWER_BASE)
#define XH_CLOCK                       ((XH_CLOCK_Type          *) XH_CLOCK_BASE)
#define XH_MPU                         ((XH_MPU_Type            *) XH_MPU_BASE)
#define XH_PU                          ((XH_PU_Type             *) XH_PU_BASE)
#define XH_AMLI                        ((XH_AMLI_Type           *) XH_AMLI_BASE)
#define XH_RADIO                       ((XH_RADIO_Type          *) XH_RADIO_BASE)
#define XH_UART0                       ((XH_UART_Type           *) XH_UART0_BASE)
#define XH_SPI0                        ((XH_SPI_Type            *) XH_SPI0_BASE)
#define XH_TWI0                        ((XH_TWI_Type            *) XH_TWI0_BASE)
#define XH_SPI1                        ((XH_SPI_Type            *) XH_SPI1_BASE)
#define XH_TWI1                        ((XH_TWI_Type            *) XH_TWI1_BASE)
#define XH_SPIS1                       ((XH_SPIS_Type           *) XH_SPIS1_BASE)
#define XH_SPIM1                       ((XH_SPIM_Type           *) XH_SPIM1_BASE)
#define XH_GPIOTE                      ((XH_GPIOTE_Type         *) XH_GPIOTE_BASE)
#define XH_ADC                         ((XH_ADC_Type            *) XH_ADC_BASE)
#define XH_TIMER0                      ((XH_TIMER_Type          *) XH_TIMER0_BASE)
#define XH_TIMER1                      ((XH_TIMER_Type          *) XH_TIMER1_BASE)
#define XH_TIMER2                      ((XH_TIMER_Type          *) XH_TIMER2_BASE)
#define XH_RTC0                        ((XH_RTC_Type            *) XH_RTC0_BASE)
#define XH_TEMP                        ((XH_TEMP_Type           *) XH_TEMP_BASE)
#define XH_RNG                         ((XH_RNG_Type            *) XH_RNG_BASE)
#define XH_ECB                         ((XH_ECB_Type            *) XH_ECB_BASE)
#define XH_AAR                         ((XH_AAR_Type            *) XH_AAR_BASE)
#define XH_CCM                         ((XH_CCM_Type            *) XH_CCM_BASE)
#define XH_WDT                         ((XH_WDT_Type            *) XH_WDT_BASE)
#define XH_RTC1                        ((XH_RTC_Type            *) XH_RTC1_BASE)
#define XH_QDEC                        ((XH_QDEC_Type           *) XH_QDEC_BASE)
#define XH_LPCOMP                      ((XH_LPCOMP_Type         *) XH_LPCOMP_BASE)
#define XH_SWI                         ((XH_SWI_Type            *) XH_SWI_BASE)
#define XH_NVMC                        ((XH_NVMC_Type           *) XH_NVMC_BASE)
#define XH_PPI                         ((XH_PPI_Type            *) XH_PPI_BASE)
#define XH_FICR                        ((XH_FICR_Type           *) XH_FICR_BASE)
#define XH_UICR                        ((XH_UICR_Type           *) XH_UICR_BASE)
#define XH_GPIO                        ((XH_GPIO_Type           *) XH_GPIO_BASE)


/** @} */ /* End of group Device_Peripheral_Registers */
/** @} */ /* End of group XH51 */
/** @} */ /* End of group XIHAO Semiconductor */
