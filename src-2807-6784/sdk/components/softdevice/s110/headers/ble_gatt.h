...
/** @brief MAX MTU size. */
#define GATT_MAX_MTU_SIZE CONFIG_HOST_MAX_ATT_MTU
...
#define BLE_GATT_OP_SIGN_WRITE_CMD         0x03  /**< Not supported. */
#define BLE_GATT_OP_PREP_WRITE_REQ         0x04  /**< Not supported. */
#define BLE_GATT_OP_EXEC_WRITE_REQ         0x05  /**< Not supported. */
/** @} */

/** @defgroup BLE_GATT_EXEC_WRITE_FLAGS GATT Execute Write flags
 * @{ */
#define BLE_GATT_EXEC_WRITE_FLAG_PREPARED_CANCEL 0x00  /**< Not supported. */
#define BLE_GATT_EXEC_WRITE_FLAG_PREPARED_WRITE  0x01  /**< Not supported. */
/** @} */
