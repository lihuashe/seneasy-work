...
enum BLE_GATTC_EVTS
{
  ...
  BLE_GATTC_EVT_MTU_CHANGED,                              /**< MTU Changed. */
};
 ...
 * @{ */
#define BLE_ERROR_GATTC_PROC_NOT_PERMITTED    (XH_GATTC_ERR_BASE + 0x000) /**< Procedure not Permitted. */
/** @} */
...
/**@brief Event structure for @ref BLE_GATTC_EVT_MTU_CHANGED. */
typedef struct
{
  uint16_t          mtu; /**< Maximum transmission unit. */
} ble_gattc_evt_mtu_changed_t;
...
typedef struct
{
  ...
  union
  {
    ...
    ble_gattc_evt_mtu_changed_t                 mtu_changed;
 ...
 *
 * @retval ::XH_SUCCESS Successfully started or resumed the Primary Service Discovery procedure.
 * @retval ::BLE_ERROR_INVALID_CONN_HANDLE Invalid Connection Handle.
 * @retval ::XH_ERROR_INVALID_STATE Invalid Connection State.
 * @retval ::XH_ERROR_INVALID_PARAM Invalid parameter(s) supplied.
 * @retval ::XH_ERROR_BUSY Client procedure already in progress.
 */
uint32_t xh_ble_gattc_primary_services_discover(uint16_t conn_handle, uint16_t start_handle, ble_uuid_t const *p_srvc_uuid);
 ...
 *
 * @retval ::XH_SUCCESS Successfully started or resumed the Relationship Discovery procedure.
 * @retval ::BLE_ERROR_INVALID_CONN_HANDLE Invalid Connection Handle.
 * @retval ::XH_ERROR_INVALID_STATE Invalid Connection State.
 ...
 * @retval ::XH_ERROR_BUSY Client procedure already in progress.
 */
uint32_t xh_ble_gattc_relationships_discover(uint16_t conn_handle, ble_gattc_handle_range_t const *p_handle_range);
 ...
 * @param[in] p_handle_range A pointer to the range of handles of the Service to perform this procedure on.
 *
 * @retval ::XH_SUCCESS Successfully started or resumed the Characteristic Discovery procedure.
 * @retval ::BLE_ERROR_INVALID_CONN_HANDLE Invalid Connection Handle.
 * @retval ::XH_ERROR_INVALID_STATE Invalid Connection State.
 * @retval ::XH_ERROR_INVALID_ADDR Invalid pointer supplied.
 * @retval ::XH_ERROR_BUSY Client procedure already in progress.
 */
uint32_t xh_ble_gattc_characteristics_discover(uint16_t conn_handle, ble_gattc_handle_range_t const *p_handle_range);
 ...
 *
 * @retval ::XH_SUCCESS Successfully started or resumed the Descriptor Discovery procedure.
 * @retval ::BLE_ERROR_INVALID_CONN_HANDLE Invalid Connection Handle.
 * @retval ::XH_ERROR_INVALID_STATE Invalid Connection State.
 * @retval ::XH_ERROR_INVALID_ADDR Invalid pointer supplied.
 * @retval ::XH_ERROR_BUSY Client procedure already in progress.
 */
uint32_t xh_ble_gattc_descriptors_discover(uint16_t conn_handle, ble_gattc_handle_range_t const *p_handle_range);
 ...
 *
 * @retval ::XH_SUCCESS Successfully started or resumed the Read using Characteristic UUID procedure.
 * @retval ::BLE_ERROR_INVALID_CONN_HANDLE Invalid Connection Handle.
 * @retval ::XH_ERROR_INVALID_STATE Invalid Connection State.
 * @retval ::XH_ERROR_INVALID_ADDR Invalid pointer supplied.
 * @retval ::XH_ERROR_BUSY Client procedure already in progress.
 */
uint32_t xh_ble_gattc_char_value_by_uuid_read(uint16_t conn_handle, ble_uuid_t const *p_uuid, ble_gattc_handle_range_t const *p_handle_range);
 ...
 *
 * @retval ::XH_SUCCESS Successfully started or resumed the Read (Long) procedure.
 * @retval ::BLE_ERROR_INVALID_CONN_HANDLE Invalid Connection Handle.
 * @retval ::XH_ERROR_INVALID_STATE Invalid Connection State.
 * @retval ::XH_ERROR_INVALID_ADDR Invalid pointer supplied.
 * @retval ::XH_ERROR_BUSY Client procedure already in progress.
 */
uint32_t xh_ble_gattc_read(uint16_t conn_handle, uint16_t handle, uint16_t offset);
 ...
 *
 * @retval ::XH_SUCCESS Successfully started the Read Multiple Characteristic Values procedure.
 * @retval ::BLE_ERROR_INVALID_CONN_HANDLE Invalid Connection Handle.
 * @retval ::XH_ERROR_INVALID_STATE Invalid Connection State.
 * @retval ::XH_ERROR_INVALID_ADDR Invalid pointer supplied.
 * @retval ::XH_ERROR_BUSY Client procedure already in progress.
 */
uint32_t xh_ble_gattc_char_values_read(uint16_t conn_handle, uint16_t const *p_handles, uint16_t handle_count);
 ...
 *
 * @retval ::XH_SUCCESS Successfully started the Write procedure.
 * @retval ::BLE_ERROR_INVALID_CONN_HANDLE Invalid Connection Handle.
 * @retval ::XH_ERROR_INVALID_STATE Invalid Connection State.
 * @retval ::XH_ERROR_INVALID_ADDR Invalid pointer supplied.
 * @retval ::XH_ERROR_INVALID_PARAM Invalid parameter(s) supplied.
 ...
 */
uint32_t xh_ble_gattc_write(uint16_t conn_handle, ble_gattc_write_params_t const *p_write_params);
 ...
 *
 * @retval ::XH_SUCCESS Successfully queued the Handle Value Confirmation for transmission.
 * @retval ::BLE_ERROR_INVALID_CONN_HANDLE Invalid Connection Handle.
 * @retval ::XH_ERROR_INVALID_STATE Invalid Connection State or no Indication pending to be confirmed.
 * @retval ::BLE_ERROR_INVALID_ATTR_HANDLE Invalid attribute handle.
 */
uint32_t xh_ble_gattc_hv_confirm(uint16_t conn_handle, uint16_t handle);
