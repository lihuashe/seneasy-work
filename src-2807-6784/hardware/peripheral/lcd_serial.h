 ...
 * @{
 *
 * @example example_lcd_2lines.c
 * This is an example of how to use the lcd_serial for 2 lines lcd
 *
 * @example example_lcd_4lines.c
 * This is an example of how to use the lcd_serial for 4 lines lcd
 */
...
// This is just to be compatible with the old version LCD driver
