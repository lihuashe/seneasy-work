...
#define audio_i2s_data_lineto_i2s_directly()   \
    do { XH_AUDIO->IF_CTRL &= ~AU_I2S_CON_CTRL_MASK; } while (0)
...
#if defined(CONFIG_XH98xx) && (CONFIG_HARDWARE_VERSION>1)
typedef enum
{
    AUDIO_SELECT_PAG_INPUT_VIP_MIC_P = 0,
    AUDIO_SELECT_PAG_INPUT_PA4        ,
    AUDIO_SELECT_PAG_INPUT_PA5        ,
    AUDIO_SELECT_PAG_INPUT_PA3        ,
    AUDIO_SELECT_PAG_INPUT_PA7        ,
...
{
    AUDIO_SELECT_PAG_INPUT_VIP_MIC_P = 0,
    AUDIO_SELECT_PAG_INPUT_PA20        , 
    AUDIO_SELECT_PAG_INPUT_PA4        , 
    AUDIO_SELECT_PAG_INPUT_PA5        , 
    AUDIO_SELECT_PAG_INPUT_PA14        , 
    AUDIO_SELECT_PAG_INPUT_PA15        , 
    AUDIO_SELECT_PAG_INPUT_PA16        , 
    AUDIO_SELECT_PAG_INPUT_PA3        , 
}audio_select_pga_input_t;
#endif
...
typedef enum
{
    AUDIO_DMIC_CLOCK_SEL_2M = 0,
    AUDIO_DMIC_CLOCK_SEL_3P2M  ,
}audio_dmic_clock_sel_t;
#endif
...
typedef void (*audio_callback_t)(void* param);
/*********************************************************************
 * EXTERN VARIABLES
 */
