...
BEE2-SDK-RCU\tool\prepend_header\prepend_header.exe -t app_code -p "bin\%linker_output_file_name%.bin" -m 1 -c sha256 -a "..\..\..\tool\key.json"
BEE2-SDK-RCU\tool\srec_cat "bin\%linker_output_file_name%.bin" -binary -offset 0x80E000 -o "bin\%linker_output_file_name%.hex" -intel
BEE2-SDK-RCU\tool\MD5\md5.exe "bin\%linker_output_file_name%.bin"
BEE2-SDK-RCU\tool\MD5\md5.exe "bin\%linker_output_file_name%_MP.bin"
