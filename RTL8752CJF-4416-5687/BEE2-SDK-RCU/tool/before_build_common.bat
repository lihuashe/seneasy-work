...
set keil_spic_algo_src=BEE2-SDK-RCU\tool\flash\RTL876x_SPI_FLASH.FLM

set keil_log_algo_dst=%keil_root%ARM\Flash\RTL876x_LOG_TRACE.FLM
set keil_log_algo_src=BEE2-SDK-RCU\tool\flash\RTL876x_LOG_TRACE.FLM
...
rem bash.exe ..\..\..\tool\version_generation\GitGenerateVersion.sh bee2-sdk- ..\..\..\tool\version_generation\ ..\..\..\inc\platform\version.h