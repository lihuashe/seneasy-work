...
#define RCU_HD_PLATFORM_SEL   R_DEMO_RCU  /* RCU Hardware Platform selection */
...
#define FEATURE_SUPPORT_POWER_ON_ADV 1  /* set 1 to enable power on adv */
...
#define ATV_VOICE_INTERACTION_MODEL ATV_INTERACTION_MODEL_ON_REQUEST  /* default assistant interaction is on request */
#endif
...
#define BAT_LPC_EN    1 /* 1 enable lpc, 0 disable */
#if BAT_LPC_EN
