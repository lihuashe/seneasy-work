...
typedef enum
{
    ...
    flash_ioctrl_wdg_reset,
    flash_ioctrl_try_high_speed,
    flash_ioctl_time_consuming_test_for_Byte_Program,
    flash_ioctl_get_temp_bank_addr_by_image_id_ext,
    flash_ioctl_get_image_addr_by_image_id_ext,
    flash_ioctl_get_aon_record_reset_reason,
    flash_ioctl_get_temp_bank_size_by_image_id,
} T_IOCTL_CODE;
 ...
 * @return true: succeed to get flash access semaphore;  false: fail to get flash access semaphore
 ...
 * @retval 1 success
  */
extern uint32_t flash_try_high_speed(T_FLASH_MODE bit_mode);
