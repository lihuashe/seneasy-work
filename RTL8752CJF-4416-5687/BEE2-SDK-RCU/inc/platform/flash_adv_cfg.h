...
/**
 * @brief write data
 * @param start_addr    start_addr address
 * @param data_len      data length to be written
 * @param data          data buffer to be written into
 * @return true if success
*/
bool flash_quick_write_locked(uint32_t start_addr, uint32_t data_len, uint8_t *data);
...
*/
bool flash_read_uuid_locked(uint8_t *uuid, uint8_t length);
