...
#define MAIN_STACK_START_ADDRESS                ( 0x00203000 )

/******************* TIMER CONFIGURATION *******************/

#define MAX_TIMER_NUM                           ( otp.os_cfg.timerMaxNumber )
#define TIMER_COUNTER_ADDR                      ( 0x00200e54 )
...
/******************* DLPS CONFIGURATION *******************/
#define LPS_WK_COUNT_ADDR                       ( 0x00201b1c )
#define LPS_WK_TIME_ADDR                        ( 0x00201b20 )
#define LPS_TOTAL_TIME                          ( 0x00201b24 )
