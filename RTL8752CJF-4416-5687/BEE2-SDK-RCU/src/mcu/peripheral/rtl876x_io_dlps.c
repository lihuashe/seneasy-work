...
volatile uint32_t
CPU_StoreReg[33];         /*  This array should be placed in RAM ON/Buffer ON.    */
volatile uint32_t
...
volatile uint32_t
GPIO_StoreReg[9];         /*  This array should be placed in RAM ON/Buffer ON.    */
...
void I2C1_DLPS_Exit(void)
{
    ...
    I2C0->IC_HS_MADDR = I2C1_StoreReg[3];
...
volatile uint32_t TIM_StoreReg[26];      /*  This array should be placed in RAM ON/Buffer ON.    */

/* PWM, use with timer */
volatile uint32_t PWM0_StoreReg;         /*  This array should be placed in RAM ON/Buffer ON.    */

volatile uint32_t PWM1_StoreReg;         /*  This array should be placed in RAM ON/Buffer ON.    */
...
volatile uint32_t
UART_StoreReg[11];        /*  This array should be placed in RAM ON/Buffer ON.    */
...
/**
  ...
  * @retval None
  */
__STATIC_INLINE void UART_DLPS_Enter(void) DATA_RAM_FUNCTION;
void UART_DLPS_Enter(void)
{
    ...
    UART_StoreReg[8] = UART->RX_IDLE_INTTCR;
    UART_StoreReg[9] = UART->RXIDLE_INTCR;
    UART_StoreReg[10] = UART->MISCR;
...
/**
  ...
  * @retval None
  */
__STATIC_INLINE void UART_DLPS_Exit(void) DATA_RAM_FUNCTION;
void UART_DLPS_Exit(void)
{
    ...
    UART->INTID_FCR = (((UART_StoreReg[7] & BIT24) >> 21) | ((UART_StoreReg[7] & 0x7C000000) >> 18) |
                       (1));
    ...
    UART->RX_IDLE_INTTCR = UART_StoreReg[8];
    UART->RXIDLE_INTCR = UART_StoreReg[9];
    UART->MISCR = UART_StoreReg[10];
...
volatile uint32_t
UART1_StoreReg[11];        /*  This array should be placed in RAM ON/Buffer ON.    */
...
void UART1_DLPS_Enter(void)
{
    ...
    UART1_StoreReg[8] = UART1->RX_IDLE_INTTCR;
    UART1_StoreReg[9] = UART1->RXIDLE_INTCR;
...
void UART1_DLPS_Exit(void)
{
    ...
    UART1->RX_IDLE_INTTCR = UART1_StoreReg[8];
    UART1->RXIDLE_INTCR = UART1_StoreReg[9];
...
__STATIC_INLINE void UART2_DLPS_Enter(void);
__STATIC_INLINE void UART2_DLPS_Exit(void);

volatile uint32_t
UART2_StoreReg[11];        /*  This array should be placed in RAM ON/Buffer ON.    */

/**
  * @brief  UART2 enter dlps callback function(Save UART2 register values when system enter DLPS)
  * @param  None
  * @retval None
  */
__STATIC_INLINE void UART2_DLPS_Enter(void) DATA_RAM_FUNCTION;
void UART2_DLPS_Enter(void)
{
    //enable log uart peripheral & clock
    SYSBLKCTRL->u_210.SOC_FUNC_EN |= (1 << 12);
    SYSBLKCTRL->u_230.CLK_CTRL |= ((1 << 12) | (1 << 13));
    ...
    //access DLH and DLL
    UART2->LCR |= (1 << 7);
    UART2_StoreReg[0] = UART2->DLL;
    UART2_StoreReg[1] = UART2->DLH_INTCR;
    UART2->LCR &= (~(1 << 7));

    //save other registers
    UART2_StoreReg[2] = UART2->DLH_INTCR;
    UART2_StoreReg[4] = UART2->LCR;
    UART2_StoreReg[5] = UART2->MCR;
    UART2_StoreReg[6] = UART2->SPR;
    UART2_StoreReg[7] = UART2->STSR;
    UART2_StoreReg[8] = UART2->RX_IDLE_INTTCR;
    UART2_StoreReg[9] = UART2->RXIDLE_INTCR;
    UART2_StoreReg[10] = UART2->MISCR;

    return;
}

/**
  * @brief  UART2 exit dlps callback function(Resume UART2 register values when system exit DLPS)
  * @param  None
  * @retval None
  */
__STATIC_INLINE void UART2_DLPS_Exit(void) DATA_RAM_FUNCTION;
void UART2_DLPS_Exit(void)
{
    //enable log uart peripheral & clock
    SYSBLKCTRL->u_210.SOC_FUNC_EN |= (1 << 12);
    SYSBLKCTRL->u_230.CLK_CTRL |= ((1 << 12) | (1 << 13));
    ...
    //access DLH and DLL
    UART2->LCR |= (1 << 7);
    UART2->DLL = UART2_StoreReg[0];
    UART2->DLH_INTCR =  UART2_StoreReg[1];
    UART2->LCR &= (~(1 << 7));

    //access other registers
    UART2->INTID_FCR = (((UART2_StoreReg[7] & BIT24) >> 21) | ((UART2_StoreReg[7] & 0x7C000000)
                                                               >> 18) | (1));
    UART2->LCR = UART2_StoreReg[4];
    UART2->MCR = UART2_StoreReg[5];
    UART2->SPR = UART2_StoreReg[6];
    UART2->STSR = UART2_StoreReg[7];
    UART2->DLH_INTCR = UART2_StoreReg[2];
    UART2->RX_IDLE_INTTCR = UART2_StoreReg[8];
    UART2->RXIDLE_INTCR = UART2_StoreReg[9];
    UART2->MISCR = UART2_StoreReg[10];
...
volatile uint32_t
ADC_StoreReg[14];        /*  This array should be placed in RAM ON/Buffer ON.    */
...
void ADC_DLPS_Enter(void)
{
    ...
    ADC_StoreReg[10] =  ADC->SCHTAB6;    //0x2C
...
volatile uint32_t LCD_StoreReg[5];

/**
  * @brief  LCD enter dlps callback function(Save LCD register values when system enter DLPS)
  * @param  None
  * @retval None
  */
__STATIC_INLINE void LCD_DLPS_Enter(void) DATA_RAM_FUNCTION;
void LCD_DLPS_Enter(void)
{
    /* Enable LCD 8080 interface controller function */
    PERIPH->PERI_FUNC0_EN |= BIT(25);
    /* Enable LCD 8080 interface controller clock */
    PERIPH->PERI_CLK_CTRL1 |= BIT(28) | BIT(29);

    LCD_StoreReg[0] = *((volatile uint32_t *)0x400002A8UL) & (0x03 << 28);
    LCD_StoreReg[1] = LCD->IMR;
    LCD_StoreReg[2] = LCD->CTRL0;
    LCD_StoreReg[3] = LCD->CTRL1;
    LCD_StoreReg[4] = LCD->CFG;

}

/**
  * @brief  LCD exit dlps callback function(Resume LCD register values when system exit DLPS)
  * @param  None
  * @retval None
  */
__STATIC_INLINE void LCD_DLPS_Exit(void) DATA_RAM_FUNCTION;
void LCD_DLPS_Exit(void)
{
    /* Enable LCD 8080 interface controller function */
    PERIPH->PERI_FUNC0_EN |= BIT(25);
    /* Enable LCD 8080 interface controller clock */
    ...
    *((volatile uint32_t *)0x400002A8UL) |= LCD_StoreReg[0];

    /* Initialize LCD */

    LCD->IMR    = LCD_StoreReg[1];
    LCD->CTRL1  = LCD_StoreReg[3];
    LCD->CFG    = LCD_StoreReg[4];
    LCD->CTRL0  = LCD_StoreReg[2];
}
#endif
...
volatile uint32_t I2S1_StoreReg[4];
...
volatile uint32_t CODEC_StoreReg[7];
...
void CODEC_DLPS_Enter(void)
{
    ...
    CODEC_StoreReg[1] = CODEC->CR1;
    CODEC_StoreReg[2] = CODEC->CR2;
    CODEC_StoreReg[3] = CODEC->CLK_CTRL;
    CODEC_StoreReg[4] = CODEC->I2S_CTRL;
    CODEC_StoreReg[5] = CODEC->ADC_CTRL;
    CODEC_StoreReg[6] = CODEC->DAC_CTRL;
}
...
void CODEC_DLPS_Exit(void)
{
    ...
    if ((CODEC_StoreReg[3] & 0x900) == 0x900)
    {
        ...
        CODEC->CR1 = CODEC_StoreReg[1];
        CODEC->CR2 = CODEC_StoreReg[2];
    }
    ...
    CODEC->CLK_CTRL = CODEC_StoreReg[3];
    CODEC->I2S_CTRL = CODEC_StoreReg[4];
    CODEC->ADC_CTRL = CODEC_StoreReg[5];
    CODEC->DAC_CTRL = CODEC_StoreReg[6];
}
#endif
...
/*******************************************************************************************************/
/*******************************************************************************************************/
#if USE_CODEC_EQ1_DLPS

volatile uint32_t CODEC_EQ1_StoreReg[5];

/**
  * @brief  CODEC_EQ1 enter dlps callback function(Save CODEC_EQ1 register values when system enter DLPS)
  * @param  None
  * @retval None
  */
__STATIC_INLINE void CODEC_EQ1_DLPS_Enter(void) DATA_RAM_FUNCTION;
void CODEC_EQ1_DLPS_Enter(void)
{
    /* Enable codec function and clock */
    PERIPH->PERI_BD_FUNC0_EN |= (1 << 0) | (1 << 4);

    CODEC_EQ1_StoreReg[0] = CODEC_EQ1->EQ_H0;
    CODEC_EQ1_StoreReg[1] = CODEC_EQ1->EQ_B1;
    CODEC_EQ1_StoreReg[2] = CODEC_EQ1->EQ_B2;
    CODEC_EQ1_StoreReg[3] = CODEC_EQ1->EQ_A1;
    CODEC_EQ1_StoreReg[4] = CODEC_EQ1->EQ_A2;
}
...
/**
  ...
  * @retval None
  */
__STATIC_INLINE void CODEC_EQ1_DLPS_Exit(void) DATA_RAM_FUNCTION;
void CODEC_EQ1_DLPS_Exit(void)
{
    /* Enable codec function and clock */
    PERIPH->PERI_BD_FUNC0_EN |= (1 << 0) | (1 << 4);

    CODEC_EQ1->EQ_H0 = CODEC_EQ1_StoreReg[0];
    CODEC_EQ1->EQ_B1 = CODEC_EQ1_StoreReg[1];
    CODEC_EQ1->EQ_B2 = CODEC_EQ1_StoreReg[2];
    CODEC_EQ1->EQ_A1 = CODEC_EQ1_StoreReg[3];
    CODEC_EQ1->EQ_A2 = CODEC_EQ1_StoreReg[4];
}
#endif
...
/*******************************************************************************************************/
/*******************************************************************************************************/
#if USE_CODEC_EQ2_DLPS

volatile uint32_t CODEC_EQ2_StoreReg[5];

/**
  * @brief  CODEC_EQ2 enter dlps callback function(Save CODEC_EQ2 register values when system enter DLPS)
  * @param  None
  * @retval None
  */
__STATIC_INLINE void CODEC_EQ2_DLPS_Enter(void) DATA_RAM_FUNCTION;
void CODEC_EQ2_DLPS_Enter(void)
{
    /* Enable codec function and clock */
    PERIPH->PERI_BD_FUNC0_EN |= (1 << 0) | (1 << 4);

    CODEC_EQ2_StoreReg[0] = CODEC_EQ2->EQ_H0;
    CODEC_EQ2_StoreReg[1] = CODEC_EQ2->EQ_B1;
    CODEC_EQ2_StoreReg[2] = CODEC_EQ2->EQ_B2;
    CODEC_EQ2_StoreReg[3] = CODEC_EQ2->EQ_A1;
    CODEC_EQ2_StoreReg[4] = CODEC_EQ2->EQ_A2;
}

/**
  * @brief  CODEC_EQ2 exit dlps callback function(Resume CODEC_EQ2 register values when system exit DLPS)
  * @param  None
  * @retval None
  */
__STATIC_INLINE void CODEC_EQ2_DLPS_Exit(void) DATA_RAM_FUNCTION;
void CODEC_EQ2_DLPS_Exit(void)
{
    /* Enable codec function and clock */
    PERIPH->PERI_BD_FUNC0_EN |= (1 << 0) | (1 << 4);

    CODEC_EQ2->EQ_H0 = CODEC_EQ2_StoreReg[0];
    CODEC_EQ2->EQ_B1 = CODEC_EQ2_StoreReg[1];
    CODEC_EQ2->EQ_B2 = CODEC_EQ2_StoreReg[2];
    CODEC_EQ2->EQ_A1 = CODEC_EQ2_StoreReg[3];
    CODEC_EQ2->EQ_A2 = CODEC_EQ2_StoreReg[4];
}
#endif
...
/*******************************************************************************************************/
/*******************************************************************************************************/
#if USE_CODEC_EQ3_DLPS

volatile uint32_t CODEC_EQ3_StoreReg[5];

/**
  * @brief  CODEC_EQ3 enter dlps callback function(Save CODEC_EQ3 register values when system enter DLPS)
  * @param  None
  * @retval None
  */
__STATIC_INLINE void CODEC_EQ3_DLPS_Enter(void) DATA_RAM_FUNCTION;
void CODEC_EQ3_DLPS_Enter(void)
{
    /* Enable codec function and clock */
    PERIPH->PERI_BD_FUNC0_EN |= (1 << 0) | (1 << 4);

    CODEC_EQ3_StoreReg[0] = CODEC_EQ3->EQ_H0;
    CODEC_EQ3_StoreReg[1] = CODEC_EQ3->EQ_B1;
    CODEC_EQ3_StoreReg[2] = CODEC_EQ3->EQ_B2;
    CODEC_EQ3_StoreReg[3] = CODEC_EQ3->EQ_A1;
    CODEC_EQ3_StoreReg[4] = CODEC_EQ3->EQ_A2;
}

/**
  * @brief  CODEC_EQ3 exit dlps callback function(Resume CODEC_EQ3 register values when system exit DLPS)
  * @param  None
  * @retval None
  */
__STATIC_INLINE void CODEC_EQ3_DLPS_Exit(void) DATA_RAM_FUNCTION;
void CODEC_EQ3_DLPS_Exit(void)
{
    /* Enable codec function and clock */
    PERIPH->PERI_BD_FUNC0_EN |= (1 << 0) | (1 << 4);

    CODEC_EQ3->EQ_H0 = CODEC_EQ3_StoreReg[0];
    CODEC_EQ3->EQ_B1 = CODEC_EQ3_StoreReg[1];
    CODEC_EQ3->EQ_B2 = CODEC_EQ3_StoreReg[2];
    CODEC_EQ3->EQ_A1 = CODEC_EQ3_StoreReg[3];
    CODEC_EQ3->EQ_A2 = CODEC_EQ3_StoreReg[4];
}
#endif
...
/*******************************************************************************************************/
/*******************************************************************************************************/
#if USE_CODEC_EQ4_DLPS

volatile uint32_t CODEC_EQ4_StoreReg[5];

/**
  * @brief  CODEC_EQ4 enter dlps callback function(Save CODEC_EQ4 register values when system enter DLPS)
  * @param  None
  * @retval None
  */
__STATIC_INLINE void CODEC_EQ4_DLPS_Enter(void) DATA_RAM_FUNCTION;
void CODEC_EQ4_DLPS_Enter(void)
{
    /* Enable codec function and clock */
    PERIPH->PERI_BD_FUNC0_EN |= (1 << 0) | (1 << 4);

    CODEC_EQ4_StoreReg[0] = CODEC_EQ4->EQ_H0;
    CODEC_EQ4_StoreReg[1] = CODEC_EQ4->EQ_B1;
    CODEC_EQ4_StoreReg[2] = CODEC_EQ4->EQ_B2;
    CODEC_EQ4_StoreReg[3] = CODEC_EQ4->EQ_A1;
    CODEC_EQ4_StoreReg[4] = CODEC_EQ4->EQ_A2;
}

/**
  * @brief  CODEC_EQ4 exit dlps callback function(Resume CODEC_EQ4 register values when system exit DLPS)
  * @param  None
  * @retval None
  */
__STATIC_INLINE void CODEC_EQ4_DLPS_Exit(void) DATA_RAM_FUNCTION;
void CODEC_EQ4_DLPS_Exit(void)
{
    /* Enable codec function and clock */
    PERIPH->PERI_BD_FUNC0_EN |= (1 << 0) | (1 << 4);

    CODEC_EQ4->EQ_H0 = CODEC_EQ4_StoreReg[0];
    CODEC_EQ4->EQ_B1 = CODEC_EQ4_StoreReg[1];
    CODEC_EQ4->EQ_B2 = CODEC_EQ4_StoreReg[2];
    CODEC_EQ4->EQ_A1 = CODEC_EQ4_StoreReg[3];
    CODEC_EQ4->EQ_A2 = CODEC_EQ4_StoreReg[4];
}
#endif
...
/*******************************************************************************************************/
/*******************************************************************************************************/
#if USE_CODEC_EQ5_DLPS

volatile uint32_t CODEC_EQ5_StoreReg[5];

/**
  * @brief  CODEC_EQ5 enter dlps callback function(Save CODEC_EQ5 register values when system enter DLPS)
  * @param  None
  * @retval None
  */
__STATIC_INLINE void CODEC_EQ5_DLPS_Enter(void) DATA_RAM_FUNCTION;
void CODEC_EQ5_DLPS_Enter(void)
{
    /* Enable codec function and clock */
    PERIPH->PERI_BD_FUNC0_EN |= (1 << 0) | (1 << 4);

    CODEC_EQ5_StoreReg[0] = CODEC_EQ5->EQ_H0;
    CODEC_EQ5_StoreReg[1] = CODEC_EQ5->EQ_B1;
    CODEC_EQ5_StoreReg[2] = CODEC_EQ5->EQ_B2;
    CODEC_EQ5_StoreReg[3] = CODEC_EQ5->EQ_A1;
    CODEC_EQ5_StoreReg[4] = CODEC_EQ5->EQ_A2;
}

/**
  * @brief  CODEC_EQ5 exit dlps callback function(Resume CODEC_EQ5 register values when system exit DLPS)
  * @param  None
  * @retval None
  */
__STATIC_INLINE void CODEC_EQ5_DLPS_Exit(void) DATA_RAM_FUNCTION;
void CODEC_EQ5_DLPS_Exit(void)
{
    /* Enable codec function and clock */
    PERIPH->PERI_BD_FUNC0_EN |= (1 << 0) | (1 << 4);

    CODEC_EQ5->EQ_H0 = CODEC_EQ5_StoreReg[0];
    CODEC_EQ5->EQ_B1 = CODEC_EQ5_StoreReg[1];
    CODEC_EQ5->EQ_B2 = CODEC_EQ5_StoreReg[2];
    CODEC_EQ5->EQ_A1 = CODEC_EQ5_StoreReg[3];
    CODEC_EQ5->EQ_A2 = CODEC_EQ5_StoreReg[4];
}
#endif
...
#if USE_CODEC_EQ1_DLPS
    CODEC_EQ1_DLPS_Enter();
#endif

#if USE_CODEC_EQ2_DLPS
    CODEC_EQ2_DLPS_Enter();
#endif

#if USE_CODEC_EQ3_DLPS
    CODEC_EQ3_DLPS_Enter();
#endif

#if USE_CODEC_EQ4_DLPS
    CODEC_EQ4_DLPS_Enter();
#endif

#if USE_CODEC_EQ5_DLPS
    CODEC_EQ5_DLPS_Enter();
#endif
