...
void keyscan_init_driver(uint32_t is_debounce)
{
    ...
    KeyScan_InitStruct.scantimerEn      = KeyScan_ScanInterval_Enable;//KeyScan_ScanInterval_Enable;
 ...
 */
void keyscan_timer_callback(TimerHandle_t pxTimer) DATA_RAM_FUNCTION;
