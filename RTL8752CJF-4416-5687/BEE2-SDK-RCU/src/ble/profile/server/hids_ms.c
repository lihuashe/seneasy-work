...
#define HID_OUTPUT_REPORT_ID                    2
#define HID_FEATURE_REPORT_ID                   3
...
static const T_ATTRIB_APPL hids_attr_tbl[] =
{
    ...
    /*  HID boot mouse input characteristic value .. 17*/
    {
        ATTRIB_FLAG_VALUE_APPL,                     /* wFlags */
        {                                         /* bTypeValue */
    ...
    /*  HID Information characteristic value .. 20*/
    {
        ATTRIB_FLAG_VALUE_APPL,                     /* wFlags */
        {                                           /* bTypeValue */
    ...
    /*  HID controlPoint characteristic value .. 22*/
    {
        ATTRIB_FLAG_VALUE_APPL,                     /* wFlags */
        {                                           /* bTypeValue */
