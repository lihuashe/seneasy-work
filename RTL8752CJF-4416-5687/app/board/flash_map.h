...
example:
	...
	3) OTA Bank0:                                    132K (0x00802000)
		a) OTA Header                    4K (0x00802000)
		b) Secure boot loader            4K (0x0080D000)
		c) Patch code                   40K (0x00803000)
		d) APP code                     84K (0x0080E000)
		e) APP data1                     0K (0x00823000)
		f) APP data2                     0K (0x00823000)
		g) APP data3                     0K (0x00823000)
		h) APP data4                     0K (0x00823000)
		i) APP data5                     0K (0x00823000)
		j) APP data6                     0K (0x00823000)
	4) OTA Bank1:                                      0K (0x00823000)
	...
	5) FTL:                                           32K (0x00823000)
	6) OTA Tmp:                                       84K (0x0082B000)
	7) APP Defined Section:                            0K (0x00840000)
*/
...
#define OTA_BANK0_SIZE                  0x00021000  //132K Bytes
#define OTA_BANK1_ADDR                  0x00823000
#define OTA_BANK1_SIZE                  0x00000000  //0K Bytes
#define FTL_ADDR                        0x00823000
#define FTL_SIZE                        0x00008000  //32K Bytes
#define OTA_TMP_ADDR                    0x0082B000
#define OTA_TMP_SIZE                    0x00015000  //84K Bytes
#define BKP_DATA1_ADDR                  0x00840000
...
#define BANK0_APP_SIZE                  0x00015000  //84K Bytes
#define BANK0_APP_DATA1_ADDR            0x00823000
#define BANK0_APP_DATA1_SIZE            0x00000000  //0K Bytes
#define BANK0_APP_DATA2_ADDR            0x00823000
#define BANK0_APP_DATA2_SIZE            0x00000000  //0K Bytes
#define BANK0_APP_DATA3_ADDR            0x00823000
#define BANK0_APP_DATA3_SIZE            0x00000000  //0K Bytes
#define BANK0_APP_DATA4_ADDR            0x00823000
#define BANK0_APP_DATA4_SIZE            0x00000000  //0K Bytes
#define BANK0_APP_DATA5_ADDR            0x00823000
#define BANK0_APP_DATA5_SIZE            0x00000000  //0K Bytes
#define BANK0_APP_DATA6_ADDR            0x00823000
