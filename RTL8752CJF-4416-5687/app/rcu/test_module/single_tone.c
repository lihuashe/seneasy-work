...
void single_tone_timeout_start(void) {
    if (true == os_timer_create(&single_tone_exit_timer, "single_tone_exit_timer",  1,
        ...
        APP_PRINT_INFO0("os timer start single_tone_exit_timer");
        os_timer_start(&single_tone_exit_timer);
    }
}

bool single_tone_test_check_dlps_allowed(void)
{
    return single_tone_test_is_dlps_allowed;
}
