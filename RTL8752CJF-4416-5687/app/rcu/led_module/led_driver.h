...
#define   LED_TYPE_BLINK_KEY_PRESS_MODE           (5)
#define   LED_TYPE_BLINK_PAIR_ADV                 (6)
#define   LED_TYPE_BLINK_PAIR_SUCCESS             (7)
#define   LED_TYPE_ON                             (8)
#define   LED_TYPE_MAX                             9

/*led loop bit num for each event, max value 32*/
#define   LED_LOOP_BITS_IDLE                     (32)
#define   LED_LOOP_BITS_LOW_POWER                (20)
#define   LED_LOOP_BITS_IR_LEARN_SUCCESS         (32)
#define   LED_LOOP_BITS_IR_LEARN_WAITING         (32)
#define   LED_LOOP_BITS_IR_LEARN_MODE            (32)
#define   LED_LOOP_BITS_KEY_PRESS_MODE           (10)
#define   LED_LOOP_BITS_PAIR_ADV                 (20)
...
#define LED_BIT_MAP_LOW_POWER             (0x003ff)
...
#define LED_BIT_MAP_KEY_PRESS_MODE        (0x3E0)
#define LED_BIT_MAP_PAIR_ADV              (0x00007C1F)
#define LED_BIT_MAP_PAIR_SUCCESS          (0x000FFFFF)
...
extern bool ambilight_check_dlps_allowed(void);
...
#endif
#define LED_AMBILIGHT_ON()               ambilight_on()
#define LED_AMBILIGHT_OFF()              ambilight_off()
