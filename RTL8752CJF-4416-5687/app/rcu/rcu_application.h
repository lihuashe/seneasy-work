...
*/
#define RCU_CONNECT_INTERVAL               0x09
#define RCU_CONNECT_LATENCY                50
#define RCU_SUPERVISION_TIMEOUT            3000
...
typedef enum
{
    ...
    STOP_ADV_REASON_USER_CMD,        //定义停止广播原因
} T_STOP_ADV_REASON;
...
typedef enum
{
    ...
    LATENCY_SMARTRCU_PROC_BIT = 0x04,
    LATENCY_MAX_BIT_NUM       = (5),
} T_APP_LATENCY_MASK;
...
typedef struct
{
    ...
    T_SERVER_ID smartrcu_srv_id;/* to indicate the service id for smartrcu service */
