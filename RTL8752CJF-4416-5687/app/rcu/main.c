...
#endif
    Pad_Config(POWER_EN, PAD_SW_MODE, PAD_IS_PWRON, PAD_PULL_NONE, PAD_OUT_ENABLE, PAD_OUT_LOW);
// #if IR_LEARN_MODE
...
#endif
               && single_tone_test_check_dlps_allowed()

               && ambilight_check_dlps_allowed()
           );
}
#endif
...
#endif
    app_global_data.smartrcu_srv_id = smartrcu_svc_add_service((void *)app_profile_callback);
