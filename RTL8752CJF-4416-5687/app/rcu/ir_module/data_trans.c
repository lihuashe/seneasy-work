...
/**<  Function pointer used to send event to application from IR learn interrupt handle. */
...
* @return  void
*/
void IR_Learn_Handler(void) DATA_RAM_FUNCTION;
void IR_Learn_Handler(void)
{
    uint16_t len = 0;
