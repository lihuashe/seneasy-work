...
const static KeyEvent click_key_cb_arr[] = {
    KEY_CLICK_EVENT_ITEM(1, pwoer_key_cb),
    KEY_CLICK_EVENT_ITEM(5, vent_mode_key_cb),
    KEY_CLICK_EVENT_ITEM(6, heat_mode_key_cb),
    KEY_CLICK_EVENT_ITEM(7, wind_direction_key_cb),
    KEY_CLICK_EVENT_ITEM(8, cool_dry_mode_key_cb),
    KEY_CLICK_EVENT_ITEM(9, hot_dry_mode_key_cb),
    KEY_LONG_CLICK_EVENT_ITEM(1, 3000, reset_key_cb),
    KEY_LONG_CLICK_EVENT_ITEM(8, 3000, network_config_key_cb),
    KEY_COMB_LONG_CLICK_EVENT_ITEM(5, 6, 3000, pair_key_cb),
...
const static KeyEvent key_release_cb_arr[] = {
    KEY_RELEASE_EVENT_ITEM(1, power_key_release_cb),
    KEY_RELEASE_EVENT_ITEM(4, time_key_release_cb),
    KEY_RELEASE_EVENT_ITEM(5, vent_mode_key_release_cb),
    KEY_RELEASE_EVENT_ITEM(6, heat_mode_key_release_cb),
    KEY_RELEASE_EVENT_ITEM(8, cool_dry_mode_key_release_cb),
    KEY_RELEASE_EVENT_ITEM(10, wind_type_key_cb),
    KEY_RELEASE_EVENT_ITEM(11, wifi_key_cb),
    KEY_RELEASE_EVENT_ITEM(12, light_key_cb),

};
static void time_key_cb(u32 time_ms, u8 key);

const static KeyEvent key_repeat_cb_arr[] = {
    KEY_REPEAT_EVENT_ITEM(4, time_key_cb),
};

static void wifi_resetAP_key_cb(u8 key);
const static KeyEvent key_long_release_cb_arr[] = {
    KEY_LONG_RELEASE_EVENT_ITEM(11, 3000, wifi_resetAP_key_cb)};
/*============================================================================*
 *                              Global Variables
 *============================================================================*/
...
static void vent_mode_key_cb(u8 key)
{
    ...
    led_bar_light_single(&g_ledBarMode, 1, LED_LIGHT_TIME); // 点亮换气按键led
}
static void heat_mode_key_cb(u8 key)
{
#if __DEBUG__ >= __DEBUG_DEV__
    ...
    led_bar_light_single(&g_ledBarMode, 2, LED_LIGHT_TIME);
}
static void cool_dry_mode_key_cb(u8 key)
{
#if __DEBUG__ >= __DEBUG_DEV__
...
static void wifi_resetAP_key_cb(u8 key)
{
    ...
    my_log(">D%d[%s] key:%d\n", __LINE__, __FUNCTION__, key);
#endif
    send_ctrl_data(RF_SEND_WIFI_RESET_AP);
}
...
void key_handle_init()
{
    ...
    set_long_release_key_map(key_long_release_cb_arr, ARRAY_SIZE(key_long_release_cb_arr));
