...
void change_mode(uint8_t new_mode)
{
    ...
    case MODE_NANOE_X:
        duration_index = &runtime_memory.nanoeX.duration_index;
        air_dir_index = &runtime_memory.nanoeX.air_dir_index;
        air_type_index = &runtime_memory.nanoeX.air_type_index;
