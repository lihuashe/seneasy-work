...
#include <stdbool.h>
    ...
    typedef struct
    {
        ...
        ModeMemory nanoeX;   // 离子水
        ModeMemory vent_l;   // 换气弱模式记忆
        ModeMemory vent_h;   // 换气强模式记忆
    } OperationMemory;

/* 默认运行参数 -------------------------------------------------*/
#define MODEL_TYPE MODEL_23BWN2H
...
#define DEFAULT_NANOE_X_DURATION TIME_03_00_INDEX  // 离子水
...
// 干燥模式公共配置
#define DRY_DEFAULT_AIR_DIR AIR_DIR_AUTO_INDEX
#define DRY_DEFAULT_AIR_TYPE AIR_TYPE_FOCUS_INDEX

// 换气模式风向、风种
#define VENT_DEFAULT_AIR_DIR AIR_DIR_NO_SETTING_INDEX
#define VENT_DEFAULT_AIR_TYPE AIR_TYPE_FOCUS_INDEX

// 离子水模式运行时间、风向、风种
#define NANOE_X_DEFAULT_AIR_DIR AIR_DIR_AUTO_INDEX
#define NANOE_X_DEFAULT_AIR_TYPE AIR_TYPE_FOCUS_INDEX
...
#define DEFAULT_MEMORY                                             \
    {                                                              \
        ...
        .vent_l = {.air_dir_index = VENT_DEFAULT_AIR_DIR,          \
                   .air_type_index = VENT_DEFAULT_AIR_TYPE,        \
                   .duration_index = DEFAULT_VENT_DURATION},       \
        .vent_h = {.air_dir_index = VENT_DEFAULT_AIR_DIR,          \
                   .air_type_index = VENT_DEFAULT_AIR_TYPE,        \
                   .duration_index = DEFAULT_VENT_DURATION},       \
        .nanoeX = {.air_dir_index = NANOE_X_DEFAULT_AIR_DIR,       \
                   .air_type_index = NANOE_X_DEFAULT_AIR_TYPE,     \
                   .duration_index = DEFAULT_NANOE_X_DURATION }    \
    }
