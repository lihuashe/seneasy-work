...
# Static library link
LIBS ?= -L$(TOP)/User/gyro_module -l:imualgo_axis9.lib
...
OPT		?= -Os
# C flags
TGT_CFLAGS	?= $(ARCH_FLAGS) $(DEBUG_FLAGS) $(OPT) -std=c17 $(addprefix -D, $(LIB_FLAGS)) $(USER_DEFINE) -Wall -ffunction-sections -fdata-sections
# C++ flags
...
$(BDIR)/$(PROJECT).elf: $(OBJS) $(TOP)/$(LDSCRIPT)
	@printf "  LD\t$(LDSCRIPT) -> $@\n"
	$(Q)$(CC) -T$(TOP)/$(LDSCRIPT) $(OBJS) $(TGT_LDFLAGS) $(LIBS) -o $@
