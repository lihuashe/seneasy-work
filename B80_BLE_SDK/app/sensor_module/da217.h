...
#define DA267_INIT_EN           1
#define DA260B_INIT_EN          1

_attribute_data_retention_ bool int_wake_up_level; 
...
#if DA267_INIT_EN
    REG_DA267_ACTIVE      = 0x38,
    REG_DA267_ACTIVE_DUR  = REG_DA267_ACTIVE,
    REG_ACTIVE_X_THS,
    REG_ACTIVE_Y_THS,
    REG_ACTIVE_Z_THS,
#endif
...
typedef struct sensor_conf_da267_t {
    // 0x0F
    struct {
        u8 full_scale:2;
        u8 resolution:2;
...
typedef struct sensor_int_da267_set_t {
    // 0x15
    struct {
        u8 step:1;
        u8 sign_motion:1;
...
}sensor_int_da267_set_t;

typedef struct sensor_int_da267_map_t {
    // 0x19
    struct {
        u8 int1_freefall:1;
        u8 int1_step:1;
...
}sensor_int_da267_map_t;

typedef struct sensor_int_conf_da267_t {
    // 0x20
    struct {
        u8 int1_level:1;
        u8 int1_od:1;
...
}sensor_int_conf_da267_t;

typedef struct sensor_func_act_da267_t {
    // 0x38 - 0x3B
    struct {
        u8 active_duration:4;
        u8 inactive_duration:4;
...
}sensor_func_act_da267_t;

typedef enum perf_mode_t {
    LOW_POWER_MODE,
    PERFERMANCE_MODE
}perf_mode_t;

typedef enum perf_level_t {
    PERF_LEVEL_0,
    PERF_LEVEL_1,
    PERF_LEVEL_2,
    PERF_LEVEL_3,
...
#if(DA260B_INIT_EN)
typedef struct sensor_conf_da260b_t {
    // 0x0F
    struct {
        u8 full_scale:2;
        u8 :6;
    }resolution_range_da260b;
    ...
    struct {
        ...
        u8 x_pol:1;
        u8 :4;
    }swap_polarity_da260b;
}sensor_conf_da260b_t;

typedef struct sensor_int_da260b_set_t {
    // 0x16
    struct {
        u8 x_active:1;
        u8 y_active:1;
...
}sensor_int_da260b_set_t;

typedef struct sensor_int_da260b_map_t {
    // 0x19
    struct {
        u8 :2;
        u8 int1_active:1;
...
}sensor_int_da260b_map_t;

typedef struct sensor_int_conf_da260b_t {
    // 0x20
    struct {
        u8 int1_level:1;
        u8 int1_od:1;
...
}sensor_int_conf_da260b_t;

typedef struct sensor_func_act_da260b_t {
    // 0x27 - 0x28
    struct {
        u8 active_duration:4;
        u8 inactive_duration:4;
...
#define MSA_I2C_ADDR     0xC4          //i2c地址 MIR3DA 公司的 为0x4E  MSA 公司的 为 0xC4
#define MSA311_CHIP_ID   0x13
